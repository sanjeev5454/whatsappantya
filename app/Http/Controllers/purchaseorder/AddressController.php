...
class AddressController extends Controller {
	...
	public function deliveryAddress() {
		...
		return view('purchaseorder.address.delivery-address',['address_data' => $address_data]);
	}
	
	public function addAddress() {
		return view('purchaseorder.address.add-address');
	}
	...
	public function addressDataPost(Request $request) {
		...
		return redirect()->to('/purchaseorder/delivery-address');
	}
	
	public function editAddress(Request $request, $id) {
		$address_data = Address::find($id);
		return view('purchaseorder.address.edit-address',['address_data' => $address_data]);
	}
	...
	public function defaultAddress(Request $request, $id) {
		...
		DB::table('tbl_address')->update(['default_address' =>0]);
		$address_data_update = Address::find($id);
