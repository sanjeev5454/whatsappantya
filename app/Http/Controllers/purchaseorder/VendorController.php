...
class VendorController extends Controller {
	...
	public function vendorListing() {
		$vendor_data = Vendor::orderBy('_id', 'desc')->get();
		return view('purchaseorder.vendor.vendor-listing',['vendor_data' => $vendor_data]);
	}
	
	public function addVendor() {
		return view('purchaseorder.vendor.add-vendor');
	}
	
	public function vendorDataPost(Request $request) {
		$customMessages = [
			'vendor_name.*' => 'Vendor Name must be filled out.',
			'vendor_code.*' => 'Vendor Code must be filled out.',
		...
		$vendor_data_save->vendor_code = $request->vendor_code;
		...
		return redirect()->to('/purchaseorder/vendor-listing');
	}
	
	public function editVendor(Request $request, $id) {
		$vendor_data = Vendor::find($id);
		return view('purchaseorder.vendor.edit-vendor',['vendor_data' => $vendor_data]);
	}
	...
	public function vendorDataUpdate(Request $request, $id){
		...
		$vendor_data_update->vendor_code = $request->vendor_code;
