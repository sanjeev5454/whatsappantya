...
class ItemController extends Controller
{
	...
	{
	 $item_data = Item::orderBy('_id', 'desc')->paginate(5);
	 return view('item.item-listing',['item_data' => $item_data]);
	}
	...
	return view('item.add-item',['vendors'=>$vendors,'other_unit' => $other_unit]);
	}
	...
	public function itemDataPost(Request $request)
	{
		...
		return redirect()->to('/item-listing');
	}
	...
	public function editItem(Request $request, $id)
	{
		...
		if(!empty($item_data)){
		return view('item.edit-item',['item_data' => $item_data,'vendors'=>$vendors,'other_unit'=>$other_unit]);
		}else{
