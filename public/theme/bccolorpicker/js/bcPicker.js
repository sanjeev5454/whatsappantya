...
$(document).ready(function(){
	...
	$('body').on('click', '.bcPicker-picker', function(){
		...
		$('#bcPicker2 .bcPicker-palette').toggle('fast');
	});
	...
	$('.bcPicker-palette').on('click', '.bcPicker-color', function(){
		...
		//$.fn.bcPicker.pickColor(color);
		$('.bcPicker-picker').css({'background-color':color});
		$('#bcPicker2 .bcPicker-palette').toggle('fast');
	});
}); */
...
(function( $ ) {
	...
	**/
	var templates = {
		picker 	: $('<div class="bcPicker-picker" id="color_div_1"></div>'),
		palette : $('<div class="bcPicker-palette" id="platter_1"></div>'),
