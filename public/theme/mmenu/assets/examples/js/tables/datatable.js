    ...
    var EditableTable = {
      ...
      build: function build() {
        this.datatable = this.$table.DataTable({
          aoColumns: [null, null, null,null, {   /// 24 Jan 2019 === null=number of inpt fields in table to create
            "bSortable": false
          }],
          language: {
