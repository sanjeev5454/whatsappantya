  ...
  <div class="page-content container-fluid">
    <div class="row justify-content-md-center">
      <div class="col-md-12">
        ...
        <?php } ?>
        <form class="" action="{{ url('new-purchase-order') }}" method="post" autocomplete="on" onsubmit="return validate();">
          @csrf
          <div class="card">
            <div class="card-body">
                ...
                <div class="search-form">
                  <div class="search-form-box">
                    ...
                    <div class="date-form">
                      ...
                      <input type="input" id="reference" class="form-control" autocomplete="off" required name="reference">
                    </div>
                    <div class="date-form">
                ...
                <div class="table-wrap">
                  <table class="editable-table table table-striped" id="editableTable1">
                    ...
                    <tr id="data-row-{{ $i }}" class="text-fields-tr">
                      ...
                      <td data-text="Item SKU" id="data-row-item-sku-{{ $i }}"><span class="blankspan"></span></td>
                      <input type="hidden" class="form-control width-full" rel="item-sku" id="tmp_id_item_sku-{{$i}}" name="row[{{$i}}][item_sku]" />
                      <td data-text="Quantity"><input required type="text" min="1" autocomplete="off" class="form-control width-full quantity" cus="{{$i}}" rel="quantity" id="tmp_id_qty_{{$i}}" name="row[{{$i}}][quantity]" /></td>
                      ...
                      <td data-text="Price"><input required type="text" min="1" autocomplete="off" class="form-control width-full price" cus="{{$i}}" rel="price" id="tmp_id_price_{{$i}}" name="row[{{$i}}][price]" /></td>
                      <td data-text="Disc %"><input type="text" min="1" maxlength="2" autocomplete="off" class="form-control width-full disc" cus="{{$i}}" rel="disc" id="tmp_id_disc_{{$i}}" name="row[{{$i}}][disc]" /></td>
                      <td data-text="Amount INR" id="data-row-amount-{{ $i }}" class="amount" style="font-weight:bold;" align="right"><span class="blankspan"></span></td>
                      <input type="hidden" class="form-control width-full" rel="amount" id="tmp_id_amount_{{$i}}" name="row[{{$i}}][amount]" />
                      <td data-text="GST %"><input type="text" readonly=""  maxlength="3" autocomplete="off" class="form-control width-full gst" rel="gst" cus="{{$i}}" id="tmp_id_gst_{{$i}}" name="row[{{$i}}][gst]" />
                ...
                <div class="add-row">
                  ...
                  <div class="row address-wrap">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text" id="telephone" name="address[telephone]" value="{{ $default_address->tel_country.' '.$default_address->tel_area.' '.$default_address->tel_number }}" class="form-control">
