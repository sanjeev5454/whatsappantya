  ...
  <div class="page-content container-fluid">
    ...
    <div class="row ">
	  ...
	  <?php if(@Session::get('success')!=''){?>
        ...
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{ url('purchaseorder/vendorDataUpdate/'.$vendor_data->id) }}" enctype="multipart/form-data" onsubmit="return vendorDataPostValidate();">
              @csrf
              <div id="formsteps" class="form-group col-lg-12 col-md-12">
                ...
                <div class="form-group row">
                  <div class=" col-lg-12">
                    ...
                    <input type="text" class="form-control" name="vendor_code" autocomplete="off" value="{{ $vendor_data->vendor_code }}" id="vendor_code">
