...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="border-table">
        <tr style="background-color: #e5e5e5;">
          @if($own_data['code_vendor']==1 || $own_data['code_vendor']==0)
          <th><strong>VENDOR DETAILS</strong></th>
          @endif
          @if($own_data['code_vendor']==1)
        ...
        @if($own_data['code_vendor']==1 || $own_data['code_vendor']==0)
        <td>
            {{ $purchase_data->contact }} 
            @if($own_data['code_vendor']==1)
            <br>Mobile No.:{{ vendorDetails($purchase_data->contact)['mobile_number'] }} 
            @endif
            </td>
        @endif
        @if($own_data['code_vendor']==1)
  ...
  <tr>
    ...
    <td colspan="7" width="315px" style="border-right:1px solid #cdcdcd; border-left:1px solid #cdcdcd; border-bottom:1px solid #cdcdcd; text-align:left">{{ ItemDetails($purchase_data->row[$i]['item']) }}</td>
  ...
  <tr>
    ...
    <td colspan="7" width="315px" style="border-right:1px solid #cdcdcd; border-left:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-bottom:1px solid #cdcdcd; text-align:left">{{ ItemSKU($purchase_data->row[$i]['item']) }}</td>
  </tr>
  <tr>
    ...
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="30px">Qty</th>
    <td style="border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="30px">{{ $purchase_data->row[$i]['quantity'] }}</td>
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="30px">Size</th>
    <td style="border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="30px">{{ $purchase_data->row[$i]['size'] }}</td>
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;"  width="35px">Price</th>
    <td style="border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="50px">{{ number_format($purchase_data->row[$i]['price'],2) }}</td>
    <th style="background-color: #e5e5e5;border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="38px">Disc.%</th>
    <td style="border-right:1px solid #fff; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="27px">{{ $purchase_data->row[$i]['disc'] }}</td>
  </tr>
</table></td>
  </tr>
  @endfor
  <tr>
    <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="border-table">
        <tr>
          <td align="right" style="font-weight:bold; background-color: #e5e5e5;" width="350px">Subtotal</td>
