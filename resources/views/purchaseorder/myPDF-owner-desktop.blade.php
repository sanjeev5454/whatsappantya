...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  ...
  <tr>
    ...
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="60px">Qty</th>
    ...
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;"  width="60px">Price</th>
    <td style="border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="82px">{{ number_format($purchase_data->row[$i]['price'],2) }}</td>
    <th style="background-color: #e5e5e5;border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;">Disc.%</th>
