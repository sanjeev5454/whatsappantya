...
<div class="new-form">
    ...
    <div class="row ">
	  ...
	  <?php if(@Session::get('success')!=''){?>
        ...
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{ url('purchaseorder/addressDataUpdate/'.$address_data->id) }}" enctype="multipart/form-data" onsubmit="return addressDataUpdateValidate();">
              @csrf
              <div id="formsteps" class="form-group col-lg-12 col-md-12">
				...
				<div class="form-group row state-box">
              ...
              <div class="form-group row creat-fms-btn">
                <div class="col-md-12">
				 ...
				 <!-- <a href="{{ url('purchaseorder/delivery-address') }}" title="Back"><button type="button" class="btn btn-danger waves-effect waves-classic waves-effect waves-classic"> Back</button></a>-->
                  </div>
              </div>
			  </div>
            </form>
