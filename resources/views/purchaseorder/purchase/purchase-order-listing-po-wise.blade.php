    ...
    <div class="panel">
      ...
      <div class="pane-body">
        ...
        <div class="tab-content tab-table-fix" id="myTabContent">
          <div class=" table-layout-fixed message-planner-box purchase-order-listing-table" id="billed" role="tabpanel" aria-labelledby="billed-tab">
            <table class="table responsive-table dataTable" cellspacing="0" id="exampleAddRow1">
              <thead>
                <tr>
                  <th class="sort ta">#PO</th>
                  <th>PO Date</th>
                  <!--<th>Delivery Date</th>-->
                  <!--<th>Items</th>-->
                  <!--<th>Qty</th>-->
