    ...
    <div class="panel">
      ...
      <div class="pane-body">
        ...
        <ul class="nav nav-tabs tab-res-tab" id="myTab" role="tablist" style="margin-bottom:10px;">
          ...
          <li class="nav-item"> <a class="nav-link active">Draft ({{ count($purchase_data_draft) }})</a> </li>
        ...
        <div class="tab-content tab-table-fix" id="myTabContent">
          <div class="show table-layout-fixed message-planner-box purchase-order-listing-table" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <table class="table responsive-table dataTable t2" cellspacing="0" id="exampleAddRow1">
              <thead>
                <tr>
                  <th class="sort ta po-th" style="cursor:pointer;" id="heder_po_draft">#PO</th>
                  <th class="sort ta vendor-th" style="cursor:pointer;" id="heder_vendor_draft">Vendor</th>
                  <th class="sort ta date-raised-th" style="cursor:pointer;" id="heder_date_draft">Date raised</th>
