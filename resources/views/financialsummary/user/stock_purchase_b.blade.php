        ...
        <table cellspacing="0" id="table-basic" class="table table-sm table-bordered table-striped fixed_table hover-edit">
          ...
          <tr class="opening_stock" id="remove-{{$i}}">
            <th class="hidden_th a-fa-click" id="a-{{$i}}"><div class="product"> <span class="sp-a-{{$i}}">{{ @$opening_stock['name'] }}</span>
              <input value="{{ @$opening_stock['name'] }}" type="text" cus="a-{{$i}}" id="{{ @$opening_stock['_id'] }}" class="a-{{$i}} e-{{$i}} attribute" autocomplete="off" name="row[{{ $i }}][name]" style="display:none;" />
          ...
          <tr class="purchases remove-{{ $i }}" id="remove-purchases-{{ @$purchases['opening_stock_id'] }}">
            <th class="hidden_th a-fa-click" id="a-{{$i}}"> <div class="product"><span class="sp-a-{{$i}} e-{{ @$purchases['opening_stock_id'] }}">{{ @$purchases['name'] }}</span>
              <input value="{{ @$purchases['name'] }}" type="text" cus="a-{{$i}}" id="{{ @$purchases['_id'] }}" class="a-{{$i}} e-{{$i}} attribute-purchase" autocomplete="off" name="row[{{ $i }}][name]" style="display:none;" />
...
$(function(){
   ...
   var id_db = $('#h-'+id_rel).val();
     $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/dataSubmitStock') }}" ,
        type: "POST",
        ...
        success: function( response ) {
		  ...
		  $('.exp-amt').attr('id', data['opening_stock']);
...
$(function(){
   ...
   var id_db = $('#h-'+id_rel).val();
     $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/dataSubmitStockAttributePurchase') }}" ,
        type: "POST",
        data: {name_val:name_val,column_name:column_name,id_db:id_db},
        success: function( response ) {
          //alert(response);
...
$(function(){
   ...
   var column_name = 'name';
     $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/dataSubmitStockAttribute') }}" ,
        type: "POST",
        data: {name_val:name_val,column_name:column_name,id_db:id_db},
        success: function( response ) {
          //alert(response);
...
$(function(){
   $(document).on('click','.add-purchases',function(){
      var rowCount = $('#table-basic >tbody >tr').length;
       $('#purchase').before('<tr class="purchases" id="remove-'+(rowCount+1)+'"> <th class="hidden_th a-fa-click" id="a-'+(rowCount+1)+'"> <div class="product"><span class="sp-a-'+(rowCount+1)+'" style="display:none;"></span> <input value="" type="text" cus="a-'+(rowCount+1)+'" class="a-'+(rowCount+1)+' e-'+(rowCount+1)+' attribute-purchase" autocomplete="off" name="row['+(rowCount+1)+'][name]" />&nbsp;<a style="padding:0px 0px !important;" id="a-'+(rowCount+1)+'" class="fa-submit-attribute-purchase fa-check-a-'+(rowCount+1)+'" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a>&nbsp;<a class="remove exp-amt" cus="'+(rowCount+1)+'" id="" href="javascript:void(0);"><i class="fa fa-trash" style="font-size:15px; color:#FF0000;" aria-hidden="true"></i></a></div> </th><input value="" type="hidden" id="h-a-'+(rowCount+1)+'" name="row['+(rowCount+1)+'][id]" /> <td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-03_2020" align="center"><span id="f-exp-amt-'+(rowCount+1)+'-03_2020" style="display:none;"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f1 number-purchase exp-amt-'+(rowCount+1)+'-03_2020 f-03_2020" value="" name="row['+(rowCount+1)+'][03_2020]" cus="exp-amt-'+(rowCount+1)+'-03_2020" id="03_2020"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-03_2020" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-03_2020" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a> </td> <td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-02_2020" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-02_2020"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f2 number-purchase exp-amt-'+(rowCount+1)+'-02_2020 f-02_2020" value="" name="row['+(rowCount+1)+'][02_2020]" cus="exp-amt-'+(rowCount+1)+'-02_2020" id="02_2020"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-02_2020" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-02_2020" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-01_2020" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-01_2020"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f3 number-purchase exp-amt-'+(rowCount+1)+'-01_2020 f-01_2020" value="" name="row['+(rowCount+1)+'][01_2020]" cus="exp-amt-'+(rowCount+1)+'-01_2020" id="01_2020"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-01_2020" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-01_2020" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-12_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-12_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f4 number-purchase exp-amt-'+(rowCount+1)+'-12_2019 f-12_2019" value="" name="row['+(rowCount+1)+'][12_2019]" cus="exp-amt-'+(rowCount+1)+'-12_2019" id="12_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-12_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-12_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-11_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-11_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f5 number-purchase exp-amt-'+(rowCount+1)+'-11_2019 f-11_2019" value="" name="row['+(rowCount+1)+'][11_2019]" cus="exp-amt-'+(rowCount+1)+'-11_2019" id="11_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-11_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-11_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-10_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-10_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f6 number-purchase exp-amt-'+(rowCount+1)+'-10_2019 f-10_2019" value="" name="row['+(rowCount+1)+'][10_2019]" cus="exp-amt-'+(rowCount+1)+'-10_2019" id="10_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-10_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-10_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-09_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-09_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f7 number-purchase exp-amt-'+(rowCount+1)+'-09_2019 f-09_2019" value="" name="row['+(rowCount+1)+'][09_2019]" cus="exp-amt-'+(rowCount+1)+'-09_2019" id="09_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-09_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-09_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-08_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-08_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f8 number-purchase exp-amt-'+(rowCount+1)+'-08_2019 f-08_2019" value="" name="row['+(rowCount+1)+'][08_2019]" cus="exp-amt-'+(rowCount+1)+'-08_2019" id="08_2019"/><a style="padding:0px 0px !important;" id="exp-amt-'+(rowCount+1)+'-08_2019" cus="exp-amt" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-08_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-07_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-07_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f9 number-purchase exp-amt-'+(rowCount+1)+'-07_2019 f-07_2019" value="" name="row['+(rowCount+1)+'][07_2019]" cus="exp-amt-'+(rowCount+1)+'-07_2019" id="07_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-07_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-07_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td><td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-06_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-06_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f10 number-purchase exp-amt-'+(rowCount+1)+'-06_2019 f-06_2019" value="" name="row['+(rowCount+1)+'][06_2019]" cus="exp-amt-'+(rowCount+1)+'-06_2019" id="06_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-06_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-06_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a> </td> <td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-05_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-05_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f11 number-purchase exp-amt-'+(rowCount+1)+'-05_2019 f-05_2019" value="" name="row['+(rowCount+1)+'][05_2019]" cus="exp-amt-'+(rowCount+1)+'-05_2019" id="05_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-05_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-05_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a> </td> <td class="hidden_td fa-click" id="exp-amt-'+(rowCount+1)+'-04_2019" align="center"><span style="display:none;" id="f-exp-amt-'+(rowCount+1)+'-04_2019"></span> <input type="text" rel="a-'+(rowCount+1)+'" autocomplete="off" style=" text-align: center;" class="f12 number-purchase exp-amt-'+(rowCount+1)+'-04_2019 f-04_2019" value="" name="row['+(rowCount+1)+'][04_2019]" cus="exp-amt-'+(rowCount+1)+'-04_2019" id="04_2019"/><a style="padding:0px 0px !important;" cus="exp-amt" id="exp-amt-'+(rowCount+1)+'-04_2019" class="fa-submit-purchase fa-check-exp-amt-'+(rowCount+1)+'-04_2019" href="javascript:void(0);"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></td></tr>');
	   $('.a-'+(rowCount+1)).focus();
	   $(".hover-edit tbody tr th:first-child").addClass("task_left_fix");
$(".hover-edit tbody tr th:first-child th").wrapAll("<div class='heading-box'></div>");
...
$(function(){
     ...
     $.ajaxSetup({
      ...
      $.ajax({
        type: "GET",
		url: "{{ url('financialsummary/dataRemoveStock')}}/"+id,
		data: {id:id},
        success: function( response ) {
