...
$(function(){
   ...
   var id_db = $('#h-'+id_rel).val();
     $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/dataSubmitStockX') }}" ,
        type: "POST",
...
$(function(){
   ...
   var id_db = $('#h-'+id_rel).val();
     $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/dataSubmitStockAttributePurchaseX') }}" ,
        type: "POST",
        data: {name_val:name_val,column_name:column_name,id_db:id_db},
        success: function( response ) {
          //alert(response);
...
$(function(){
   ...
   var column_name = 'name';
     $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/dataSubmitStockAttributeX') }}" ,
        type: "POST",
        data: {name_val:name_val,column_name:column_name,id_db:id_db},
        success: function( response ) {
          //alert(response);
...
$(document).on('click','.add-opening-stock',function(){
   ...
   $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/ajaxStockAttributePurchaseX') }}" ,
        type: "POST",
...
$(document).on('click','.add-purchases',function(){
   ...
   $.ajaxSetup({
      ...
      $.ajax({
        url: "{{ url('financialsummary/ajaxStockAttributePurchaseAddX') }}" ,
        type: "POST",
        data: {rowCount:rowCount},
        success: function( response ) {
          //alert(response);
...
$(function(){
     ...
     $.ajaxSetup({
      ...
      $.ajax({
        type: "GET",
		url: "{{ url('financialsummary/dataRemoveStockX')}}/"+id,
		data: {id:id},
        success: function( response ) {
