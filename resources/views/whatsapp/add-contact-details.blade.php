    ...
    <div class="pane">
      <div class="pane-body">
        <header class="panel-heading">
          <h3 class="panel-title">Add a Contact <a style="color:white;" class="add-label btn btn-success waves-effect waves-classic" data-toggle="modal" data-target="#myModal" href="javascript:void(0);"><i class="fa fa-upload" aria-hidden="true"></i> Import From CSV </a> <a style="color:white;" class="add-label btn btn-danger waves-effect waves-classic" href="{{ url('whatsapp/sample-download-file') }}"><i class="fa fa-download" aria-hidden="true"></i> Sample Download CSV File</a></h3>
        </header>
        <div class="new-form">
          <h2>Add a Contact</h2>
          <div class="row">
                    ...
                    <div id="formsteps" class="form-group col-lg-12 col-md-12"> <span id="result_data">
                      <div class="form-group row">
                        <div class="col-lg-12">
                          ...
                          <input type="text" class="form-control" name="company_name[]" autocomplete="off" value="{{ old('company_name') }}" id="company_name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <label>Name</label>
                          <input type="text" class="form-control" required name="name_of_contact[]" autocomplete="off" value="{{ old('name_of_contact') }}" id="name_of_contact">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <label>Mobile Number</label>
                          <input type="text" class="form-control"  required name="receiver_mobile_number[]" autocomplete="off" value="{{ old('receiver_mobile_number') }}" id="receiver_mobile_number">
                        </div>
                      </div>
                      </span>
                      <div class="add-more-contact"> <a id="add-row" href="javascript:void(0);"><i class="fa fa-plus" aria-hidden="true"></i> Add Another Contact</a></div>
