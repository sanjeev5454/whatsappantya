...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="border-table">
        ...
        <tr>
        <td>{{ $purchase_data->contact }}  <br>Mobile No.:{{ vendorDetails($purchase_data->contact)['mobile_number'] }} </td>
          <td>{{ vendorDetails($purchase_data->contact)['address'] }}</td>
            <td>{{ $purchase_data->address['attention'] }} <br>Mobile No.: {{ $purchase_data->address['telephone'] }}</td>            
        </tr>
      </table></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="7" width="315px" style="border-right:1px solid #cdcdcd; border-left:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-bottom:1px solid #cdcdcd; text-align:left">{{ $purchase_data->row[$i]['item_sku'] }}</td>
  </tr>
  <tr>
    ...
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="35px">Qty</th>
    <td style="border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;">{{ $purchase_data->row[$i]['quantity'] }}</td>
    ...
    <td style="border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;" width="65px">{{ number_format($purchase_data->row[$i]['price'],2) }}</td>
    <th style="background-color: #e5e5e5; border-right:1px solid #cdcdcd; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;">Dise.%</th>
    <td style="border-right:1px solid #fff; border-top:1px solid #cdcdcd; border-left:1px solid #cdcdcd;">{{ $purchase_data->row[$i]['disc'] }}</td>
  </tr>
</table></td>
  </tr>
  @endfor
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="border-table">
        <tr style="background-color: #e5e5e5;">
          <th><strong>DELIVERY INSTRUCTIONS</strong></th>
        </tr>
        <tr>
